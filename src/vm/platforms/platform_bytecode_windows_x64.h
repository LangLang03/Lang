...
// 66 个独立低 8 位编号（0x52-0x93 范围）
inline constexpr std::uint8_t kLocalOpcodeVerify = 0x52;
inline constexpr std::uint8_t kLocalOpcodePushInteger = 0x53;
inline constexpr std::uint8_t kLocalOpcodePushString = 0x54;
inline constexpr std::uint8_t kLocalOpcodePushNull = 0x55;
inline constexpr std::uint8_t kLocalOpcodePushReference = 0x56;
inline constexpr std::uint8_t kLocalOpcodeDereference = 0x57;
inline constexpr std::uint8_t kLocalOpcodeFieldReference = 0x58;
inline constexpr std::uint8_t kLocalOpcodeLoad = 0x59;
inline constexpr std::uint8_t kLocalOpcodeStore = 0x5A;
inline constexpr std::uint8_t kLocalOpcodeStoreDereference = 0x5B;
inline constexpr std::uint8_t kLocalOpcodeStorePointer = 0x5C;
inline constexpr std::uint8_t kLocalOpcodePop = 0x5D;
inline constexpr std::uint8_t kLocalOpcodeAdd = 0x5E;
inline constexpr std::uint8_t kLocalOpcodeAddTrap = 0x5F;
inline constexpr std::uint8_t kLocalOpcodeAddWrap = 0x60;
inline constexpr std::uint8_t kLocalOpcodeAddSaturate = 0x61;
inline constexpr std::uint8_t kLocalOpcodeAddExtend = 0x62;
inline constexpr std::uint8_t kLocalOpcodeSub = 0x63;
inline constexpr std::uint8_t kLocalOpcodeSubTrap = 0x64;
inline constexpr std::uint8_t kLocalOpcodeSubWrap = 0x65;
inline constexpr std::uint8_t kLocalOpcodeSubSaturate = 0x66;
inline constexpr std::uint8_t kLocalOpcodeSubExtend = 0x67;
inline constexpr std::uint8_t kLocalOpcodeMul = 0x68;
inline constexpr std::uint8_t kLocalOpcodeMulTrap = 0x69;
inline constexpr std::uint8_t kLocalOpcodeMulWrap = 0x6A;
inline constexpr std::uint8_t kLocalOpcodeMulSaturate = 0x6B;
inline constexpr std::uint8_t kLocalOpcodeMulExtend = 0x6C;
inline constexpr std::uint8_t kLocalOpcodeDiv = 0x6D;
inline constexpr std::uint8_t kLocalOpcodeDivTrap = 0x6E;
inline constexpr std::uint8_t kLocalOpcodeDivWrap = 0x6F;
inline constexpr std::uint8_t kLocalOpcodeDivSaturate = 0x70;
inline constexpr std::uint8_t kLocalOpcodeDivExtend = 0x71;
inline constexpr std::uint8_t kLocalOpcodeEqual = 0x72;
inline constexpr std::uint8_t kLocalOpcodeNotEqual = 0x73;
inline constexpr std::uint8_t kLocalOpcodeLess = 0x74;
inline constexpr std::uint8_t kLocalOpcodeLessEqual = 0x75;
inline constexpr std::uint8_t kLocalOpcodeGreater = 0x76;
inline constexpr std::uint8_t kLocalOpcodeGreaterEqual = 0x77;
inline constexpr std::uint8_t kLocalOpcodeAnd = 0x78;
inline constexpr std::uint8_t kLocalOpcodeOr = 0x79;
inline constexpr std::uint8_t kLocalOpcodeXor = 0x7A;
inline constexpr std::uint8_t kLocalOpcodeNand = 0x7B;
inline constexpr std::uint8_t kLocalOpcodeNor = 0x7C;
inline constexpr std::uint8_t kLocalOpcodeNot = 0x7D;
inline constexpr std::uint8_t kLocalOpcodeJump = 0x7E;
inline constexpr std::uint8_t kLocalOpcodeJumpIfZero = 0x7F;
inline constexpr std::uint8_t kLocalOpcodeCheckApproval = 0x80;
inline constexpr std::uint8_t kLocalOpcodeCheckLimits = 0x81;
inline constexpr std::uint8_t kLocalOpcodeCheckRole = 0x82;
inline constexpr std::uint8_t kLocalOpcodeCheckRoleIndirect = 0x83;
inline constexpr std::uint8_t kLocalOpcodeNullCheck = 0x84;
inline constexpr std::uint8_t kLocalOpcodeAssert = 0x85;
inline constexpr std::uint8_t kLocalOpcodeCall = 0x86;
inline constexpr std::uint8_t kLocalOpcodeCallIndirect = 0x87;
inline constexpr std::uint8_t kLocalOpcodeOutputInt = 0x88;
inline constexpr std::uint8_t kLocalOpcodeOutputChar = 0x89;
inline constexpr std::uint8_t kLocalOpcodePrintLine = 0x8A;
inline constexpr std::uint8_t kLocalOpcodeInputInt = 0x8B;
inline constexpr std::uint8_t kLocalOpcodeInputChar = 0x8C;
inline constexpr std::uint8_t kLocalOpcodeVerifyEcc = 0x8D;
inline constexpr std::uint8_t kLocalOpcodeCopyMemory = 0x8E;
inline constexpr std::uint8_t kLocalOpcodeCompareMemory = 0x8F;
inline constexpr std::uint8_t kLocalOpcodeRole = 0x90;
