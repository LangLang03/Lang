...
// android_arm32 序列化格式 (大端编码):
// [0..3]   4 字节魔数
// [4]      1 字节 platform id
// [5]      1 字节字节序标签
// [6..7]   2 字节 version (big-endian)
// [8..9]   2 字节 flags (big-endian)
// [10..]   functions -> env_fingerprint -> producer -> entry
...
std::optional<BytecodeProgram> readBytecode(std::istream& input, const std::string& name, Diagnostics& diagnostics) {
  ...
  // android_arm32: functions 在 env_fingerprint 之前
