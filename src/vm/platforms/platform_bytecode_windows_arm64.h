...
// 平台特化字节码定义：windows-arm64
// 平台 ID: 0x08 (TORTURE_PLATFORM_WINDOWS_ARM64)
// 魔数: {'T','W','A','8'}
// 后缀: WA64
// 版本: 0x0203
// flags: 0x0008
//
// 低 8 位编号方案: 0xD6-0xFF, 0x01-0x18 (环绕，共 66 个值)
...
// 平台后缀（用于 opcode 名称拼接，如 "ADD_WA64"）
...
// 66 个独立低 8 位编号 (0xD6-0xFF, 0x01-0x18 环绕)
inline constexpr std::uint8_t kLocalOpcodeVerify            = 0xD6;
inline constexpr std::uint8_t kLocalOpcodePushInteger       = 0xD7;
inline constexpr std::uint8_t kLocalOpcodePushString        = 0xD8;
inline constexpr std::uint8_t kLocalOpcodePushNull          = 0xD9;
inline constexpr std::uint8_t kLocalOpcodePushReference     = 0xDA;
inline constexpr std::uint8_t kLocalOpcodeDereference       = 0xDB;
inline constexpr std::uint8_t kLocalOpcodeFieldReference    = 0xDC;
inline constexpr std::uint8_t kLocalOpcodeLoad              = 0xDD;
inline constexpr std::uint8_t kLocalOpcodeStore             = 0xDE;
inline constexpr std::uint8_t kLocalOpcodeStoreDereference  = 0xDF;
inline constexpr std::uint8_t kLocalOpcodeStorePointer      = 0xE0;
inline constexpr std::uint8_t kLocalOpcodePop               = 0xE1;
inline constexpr std::uint8_t kLocalOpcodeAdd                = 0xE2;
inline constexpr std::uint8_t kLocalOpcodeAddTrap            = 0xE3;
inline constexpr std::uint8_t kLocalOpcodeAddWrap           = 0xE4;
inline constexpr std::uint8_t kLocalOpcodeAddSaturate        = 0xE5;
inline constexpr std::uint8_t kLocalOpcodeAddExtend          = 0xE6;
inline constexpr std::uint8_t kLocalOpcodeSub                = 0xE7;
inline constexpr std::uint8_t kLocalOpcodeSubTrap            = 0xE8;
inline constexpr std::uint8_t kLocalOpcodeSubWrap            = 0xE9;
inline constexpr std::uint8_t kLocalOpcodeSubSaturate        = 0xEA;
inline constexpr std::uint8_t kLocalOpcodeSubExtend          = 0xEB;
inline constexpr std::uint8_t kLocalOpcodeMul                = 0xEC;
inline constexpr std::uint8_t kLocalOpcodeMulTrap            = 0xED;
inline constexpr std::uint8_t kLocalOpcodeMulWrap            = 0xEE;
inline constexpr std::uint8_t kLocalOpcodeMulSaturate        = 0xEF;
inline constexpr std::uint8_t kLocalOpcodeMulExtend          = 0xF0;
inline constexpr std::uint8_t kLocalOpcodeDiv                = 0xF1;
inline constexpr std::uint8_t kLocalOpcodeDivTrap            = 0xF2;
inline constexpr std::uint8_t kLocalOpcodeDivWrap            = 0xF3;
inline constexpr std::uint8_t kLocalOpcodeDivSaturate        = 0xF4;
inline constexpr std::uint8_t kLocalOpcodeDivExtend          = 0xF5;
inline constexpr std::uint8_t kLocalOpcodeEqual              = 0xF6;
inline constexpr std::uint8_t kLocalOpcodeNotEqual           = 0xF7;
inline constexpr std::uint8_t kLocalOpcodeLess               = 0xF8;
inline constexpr std::uint8_t kLocalOpcodeLessEqual          = 0xF9;
inline constexpr std::uint8_t kLocalOpcodeGreater            = 0xFA;
inline constexpr std::uint8_t kLocalOpcodeGreaterEqual       = 0xFB;
inline constexpr std::uint8_t kLocalOpcodeAnd                = 0xFC;
inline constexpr std::uint8_t kLocalOpcodeOr                 = 0xFD;
inline constexpr std::uint8_t kLocalOpcodeXor                = 0xFE;
inline constexpr std::uint8_t kLocalOpcodeNand               = 0xFF;
inline constexpr std::uint8_t kLocalOpcodeNor                = 0x01;
inline constexpr std::uint8_t kLocalOpcodeNot                 = 0x02;
inline constexpr std::uint8_t kLocalOpcodeJump               = 0x03;
inline constexpr std::uint8_t kLocalOpcodeJumpIfZero          = 0x04;
inline constexpr std::uint8_t kLocalOpcodeCheckApproval      = 0x05;
inline constexpr std::uint8_t kLocalOpcodeCheckLimits        = 0x06;
inline constexpr std::uint8_t kLocalOpcodeCheckRole          = 0x07;
inline constexpr std::uint8_t kLocalOpcodeCheckRoleIndirect  = 0x08;
inline constexpr std::uint8_t kLocalOpcodeNullCheck          = 0x09;
inline constexpr std::uint8_t kLocalOpcodeAssert             = 0x0A;
inline constexpr std::uint8_t kLocalOpcodeCall               = 0x0B;
inline constexpr std::uint8_t kLocalOpcodeCallIndirect       = 0x0C;
inline constexpr std::uint8_t kLocalOpcodeOutputInt          = 0x0D;
inline constexpr std::uint8_t kLocalOpcodeOutputChar         = 0x0E;
inline constexpr std::uint8_t kLocalOpcodePrintLine          = 0x0F;
inline constexpr std::uint8_t kLocalOpcodeInputInt           = 0x10;
inline constexpr std::uint8_t kLocalOpcodeInputChar          = 0x11;
inline constexpr std::uint8_t kLocalOpcodeVerifyEcc          = 0x12;
inline constexpr std::uint8_t kLocalOpcodeCopyMemory         = 0x13;
inline constexpr std::uint8_t kLocalOpcodeCompareMemory      = 0x14;
inline constexpr std::uint8_t kLocalOpcodeRole                = 0x15;
inline constexpr std::uint8_t kLocalOpcodeOperatorInput      = 0x16;
inline constexpr std::uint8_t kLocalOpcodeReturn             = 0x17;
inline constexpr std::uint8_t kLocalOpcodeHalt               = 0x18;
inline constexpr std::uint8_t kLocalOpcodeApply = 0x19;
