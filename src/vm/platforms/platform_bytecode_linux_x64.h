...
// linux_x64 平台特化的字节码编号方案。
// 低 8 位编号范围：0x01 - 0x42（共 66 个值）。
// 平台 ID 高字节 = TORTURE_PLATFORM_LINUX_X64 (0x01)。
...
// ---- 66 个独立低 8 位编号（0x01 - 0x42） ----
inline constexpr std::uint8_t kLocalOpcodeVerify             = 0x01;
inline constexpr std::uint8_t kLocalOpcodePushInteger        = 0x02;
inline constexpr std::uint8_t kLocalOpcodePushString         = 0x03;
inline constexpr std::uint8_t kLocalOpcodePushNull           = 0x04;
inline constexpr std::uint8_t kLocalOpcodePushReference      = 0x05;
inline constexpr std::uint8_t kLocalOpcodeDereference        = 0x06;
inline constexpr std::uint8_t kLocalOpcodeFieldReference     = 0x07;
inline constexpr std::uint8_t kLocalOpcodeLoad               = 0x08;
inline constexpr std::uint8_t kLocalOpcodeStore              = 0x09;
inline constexpr std::uint8_t kLocalOpcodeStoreDereference   = 0x0A;
inline constexpr std::uint8_t kLocalOpcodeStorePointer       = 0x0B;
inline constexpr std::uint8_t kLocalOpcodePop                = 0x0C;
inline constexpr std::uint8_t kLocalOpcodeAdd                = 0x0D;
inline constexpr std::uint8_t kLocalOpcodeAddTrap            = 0x0E;
inline constexpr std::uint8_t kLocalOpcodeAddWrap            = 0x0F;
inline constexpr std::uint8_t kLocalOpcodeAddSaturate        = 0x10;
inline constexpr std::uint8_t kLocalOpcodeAddExtend          = 0x11;
inline constexpr std::uint8_t kLocalOpcodeSub                = 0x12;
inline constexpr std::uint8_t kLocalOpcodeSubTrap            = 0x13;
inline constexpr std::uint8_t kLocalOpcodeSubWrap            = 0x14;
inline constexpr std::uint8_t kLocalOpcodeSubSaturate        = 0x15;
inline constexpr std::uint8_t kLocalOpcodeSubExtend          = 0x16;
inline constexpr std::uint8_t kLocalOpcodeMul                = 0x17;
inline constexpr std::uint8_t kLocalOpcodeMulTrap            = 0x18;
inline constexpr std::uint8_t kLocalOpcodeMulWrap            = 0x19;
inline constexpr std::uint8_t kLocalOpcodeMulSaturate        = 0x1A;
inline constexpr std::uint8_t kLocalOpcodeMulExtend          = 0x1B;
inline constexpr std::uint8_t kLocalOpcodeDiv                = 0x1C;
inline constexpr std::uint8_t kLocalOpcodeDivTrap            = 0x1D;
inline constexpr std::uint8_t kLocalOpcodeDivWrap            = 0x1E;
inline constexpr std::uint8_t kLocalOpcodeDivSaturate        = 0x1F;
inline constexpr std::uint8_t kLocalOpcodeDivExtend          = 0x20;
inline constexpr std::uint8_t kLocalOpcodeEqual              = 0x21;
inline constexpr std::uint8_t kLocalOpcodeNotEqual           = 0x22;
inline constexpr std::uint8_t kLocalOpcodeLess               = 0x23;
inline constexpr std::uint8_t kLocalOpcodeLessEqual          = 0x24;
inline constexpr std::uint8_t kLocalOpcodeGreater            = 0x25;
inline constexpr std::uint8_t kLocalOpcodeGreaterEqual       = 0x26;
inline constexpr std::uint8_t kLocalOpcodeAnd                = 0x27;
inline constexpr std::uint8_t kLocalOpcodeOr                 = 0x28;
inline constexpr std::uint8_t kLocalOpcodeXor                = 0x29;
inline constexpr std::uint8_t kLocalOpcodeNand               = 0x2A;
inline constexpr std::uint8_t kLocalOpcodeNor                = 0x2B;
inline constexpr std::uint8_t kLocalOpcodeNot                = 0x2C;
inline constexpr std::uint8_t kLocalOpcodeJump               = 0x2D;
inline constexpr std::uint8_t kLocalOpcodeJumpIfZero         = 0x2E;
inline constexpr std::uint8_t kLocalOpcodeCheckApproval      = 0x2F;
inline constexpr std::uint8_t kLocalOpcodeCheckLimits        = 0x30;
inline constexpr std::uint8_t kLocalOpcodeCheckRole          = 0x31;
inline constexpr std::uint8_t kLocalOpcodeCheckRoleIndirect  = 0x32;
inline constexpr std::uint8_t kLocalOpcodeNullCheck          = 0x33;
inline constexpr std::uint8_t kLocalOpcodeAssert             = 0x34;
inline constexpr std::uint8_t kLocalOpcodeCall               = 0x35;
inline constexpr std::uint8_t kLocalOpcodeCallIndirect       = 0x36;
inline constexpr std::uint8_t kLocalOpcodeOutputInt          = 0x37;
inline constexpr std::uint8_t kLocalOpcodeOutputChar         = 0x38;
inline constexpr std::uint8_t kLocalOpcodePrintLine          = 0x39;
inline constexpr std::uint8_t kLocalOpcodeInputInt           = 0x3A;
inline constexpr std::uint8_t kLocalOpcodeInputChar           = 0x3B;
inline constexpr std::uint8_t kLocalOpcodeVerifyEcc          = 0x3C;
inline constexpr std::uint8_t kLocalOpcodeCopyMemory         = 0x3D;
inline constexpr std::uint8_t kLocalOpcodeCompareMemory      = 0x3E;
inline constexpr std::uint8_t kLocalOpcodeRole               = 0x3F;
inline constexpr std::uint8_t kLocalOpcodeOperatorInput      = 0x40;
inline constexpr std::uint8_t kLocalOpcodeReturn              = 0x41;
inline constexpr std::uint8_t kLocalOpcodeHalt               = 0x42;
inline constexpr std::uint8_t kLocalOpcodeApply = 0x43;
...
static_assert(kLocalOpcodeVerify == 0x01, "linux_x64 local opcode range must start at 0x01");
static_assert(kLocalOpcodeHalt == 0x42, "linux_x64 local opcode range must end at 0x42");
